...
document.getElementById("concours").addEventListener("click", function () {
  window.location.href = "concour.html";
});
...
document.getElementById("parametres").addEventListener("click", function () {
  var audio = document.getElementById("sb5");
  audio.play();
});

document.getElementById("concours").addEventListener("click", function () {
  var audio = document.getElementById("sb6");
  audio.play();
});
