// Variables globales pour stocker les scores des joueurs
let scorej1 = 0;
let scorej2 = 0;
...
const wordScores1 = {
    "ton baobab": 9, "ton arbre": 9, "ton gourmand": 10, "ton gras": 8, "ton seum": 7, "ton caca": 7, "ton sylvain": 5,
    "ton baka": 4, "ton pays": 5, "ton saperlipopette": 4, "ton neuille ": 4, "ta gourmandise": 10, "ton argument": 5,
    "ton infection": 3, "ton pensement": 3, "ton dimanche": 6, "ta salopette": 7, "ton C15": 7, "ton singe": 8,
    "ton bouffon": 8, "ta morve": 8, "ton pupitre": 8, "ton bonjour": 7, "ton coucou": 7, "ton hirondelle": 5
};

const verbescore1 = {
    "va dormir dans ": 8, "ravale ": 9, "va manger ": 9, "déguste ": 8, "reste dans ": 7, "retourne dans ": 8,
    "Lis dans ": 6, "va courir dans ": 5, "va nager dans ": 5, "Chante dans ": 6, "va jouer dans ": 5, "Graille ": 7,
    "témoigne ": 6, "édifie ": 8
};
...
document.getElementById('gen1').addEventListener('click', function() {
    ...
    scorej1 = scoreverbe1 + score1;
    document.getElementById('pointj1').textContent = scorej1;

    // Comparer les scores après la génération de la phrase pour le joueur 1
    compareScores();
});
...
document.getElementById('gen2').addEventListener('click', function() {
    ...
    scorej2 = scoreverbe + score;
    document.getElementById('pointj2').textContent = scorej2;

    // Comparer les scores après la génération de la phrase pour le joueur 2
    compareScores();
});

// Fonction pour comparer les scores des joueurs et afficher le gagnant
function compareScores() {
    if (scorej1 > scorej2) {
        console.log("Joueur 1 a le plus de points avec un score de " + scorej1);
    } else if (scorej2 > scorej1) {
        console.log("Joueur 2 a le plus de points avec un score de " + scorej2);
    } else {
        console.log("Les deux joueurs sont à égalité avec un score de " + scorej1);
    }
}
